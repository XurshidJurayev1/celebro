...
function OrderEdit(props) {
  ...
  const submitHandler = (e) => {
    ...
    adaRef.update({
      ...
      orderfinished: state.orderfinished,
      workerSend: state.workerSend,
    })
      .then(function () {
  ...
  return (
    <div className={style.main}>
      <div className={style.container}>
        ...
        >
          <h2>Confirmed</h2>
          <select value={state.orderConfirmed}
                  onChange={(e) => dispatch({ type: 'CONFIRMED', payload: e.target.value })}>
